...
opcode_map = {
    0x61: (
        'ADC',
        Mode.DIRECT_INDEXED_INDIRECT_X,
        0b11000011,
        2,
        6,
        'Add With Carry',
    ...
    0x71: (
        'ADC',
        Mode.DIRECT_INDIRECT_INDEXED_Y,
        0b11000011,
        2,
        5,
        'Add With Carry',
    ...
    0x73: (
        'ADC',
        Mode.STACK_RELATIVE_INDIRECT_INDEXED_Y,
        0b11000011,
        2,
        7,
        'Add With Carry',
    ...
    0x77: (
        'ADC',
        Mode.DIRECT_INDIRECT_INDEXED_LONG_Y,
        0b11000011,
        2,
        6,
        'Add With Carry',
    ...
    0xC3: (
        ...
        2,
        4,
        'Compare Accumulator With Meomry',
    ),  # CMP sr, S
    0xC5: (
        'CMP',
        Mode.DIRECT,
    ...
    0x86: (
        ...
        2,
        3,
        'Store Index Register X to Memorry',
    ),  # STX dp
    0x8E: (
        'STX',
        Mode.ABSOLUTE,
    ...
    0x84: (
        ...
        2,
        3,
        'Store Index Register Y to Memorry',
    ),  # STY dp
    0x8C: (
        'STY',
        Mode.ABSOLUTE,
